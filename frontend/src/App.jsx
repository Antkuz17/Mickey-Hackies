...
import { Activity, Zap, BarChart3, Wifi, WifiOff, Music } from 'lucide-react';
              ...
              {NOTES.map((note, i) => {
                ...
                return (
                  ...
                  >
                    {/* Note head (oval) */}
                    <div
                      className={`w-5 h-4 rounded-full border-2 transition-all duration-150 ${
                        i === activeNoteIndex
                    ...
                    {/* Note stem */}
                    <div
                      className={`absolute w-0.5 h-8 transition-all duration-150 ${
                        i === activeNoteIndex ? 'bg-cyan-400' : 'bg-slate-500'
                      }`}
                      style={{
                    ...
                    {/* Note letter label */}
                    <span
                      className={`absolute text-[10px] font-bold transition-all duration-150 ${
                        i === activeNoteIndex ? 'text-pink-400' : 'text-slate-600'
                      }`}
                      style={{
                        left: '50%',
          ...
          <div className="absolute top-4 right-4 z-10">
            <div className={`flex items-center gap-2 px-3 py-1.5 rounded-full ${
              ...
              <div className={`w-2 h-2 rounded-full ${
                isPlaying ? 'bg-cyan-400 animate-pulse' : 'bg-slate-500'
              }`} />
              <span className={`text-xs font-medium ${
                isPlaying ? 'text-cyan-400' : 'text-slate-500'
              }`}>
